...
<form method="GET" action="${pageContext.request.contextPath}/ControllerPizza" enctype="multipart/form-data" id="demoForm"> 
	<div class="container">
		<h2>Ajouter une pizza</h2>
		<p></p><!-- barre de séparation -->
			<%
				Pizza addPizza = (Pizza) request.getAttribute("addPizza");
			%>	
			<input type="hidden" name="action" value="addpizzavalid">
			<input type="hidden" name="idpizza" >
							
							
							<div class="form-group row">
					            <label class="col-sm-2 col-form-label"> Nom de la pizza :</label>
					            <div class="col-sm-10">
					            	<input type="text" class="form-control" name="DesignPizz" required/>
					            </div>
					        </div>
					        <br>
					        <div class="form-group row">
					            ...
					            <div class="input-group">
					                ...
					                <input type="number" name="TarifPizz" class="form-control" required/>
					            </div>
					            </div>
					        </div>
					        <br>
